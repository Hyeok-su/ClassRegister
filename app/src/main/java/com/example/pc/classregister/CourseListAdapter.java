...
public class CourseListAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Button dipsButton = (Button) v.findViewById(R.id.dipsButton);
        dipsButton.setOnClickListener(new View.OnClickListener() {
            
            // 찜목록 중복추가 없애기...
            // courseIDList를 잘 만져서 고쳐봐야 할 듯...
            @Override
            public void onClick(View v) {
                // Log.d("MyMessage", "Validate : " + validate);
                if(!alreadyIn(courseIDList, courseList.get(i).getCourseID())) {
                    ...
                    DipRequest dipRequest = new DipRequest(userID, courseList.get(i).getCourseID() + "", responseListener);
                    RequestQueue queue = Volley.newRequestQueue(parent.getActivity());
